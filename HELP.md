...
* [Migrating from Spring to Spring Boot](https://www.baeldung.com/spring-boot-migration)
...
* [Spring Boot first web application](http://zetcode.com/springboot/firstweb/)
